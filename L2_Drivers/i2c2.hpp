...
class I2C2 : public I2C_Base, public SingletonTemplate<I2C2>
{
    public:
        ...
        /**
         * Initializes I2C2 device as a slave
         *
         * @param speedInKhz   Operating frequency of I2C device
         * @param memBase      Pointer to memory location corresponding to first I2C register
         * @param memLenBytes  Length of I2C register segment (number of 8-bit registers)
         * @return Returns true on success, false otherwise
         */
        bool initSlave(unsigned int speedInKhz, void* memBase, uint32_t memLenBytes);
